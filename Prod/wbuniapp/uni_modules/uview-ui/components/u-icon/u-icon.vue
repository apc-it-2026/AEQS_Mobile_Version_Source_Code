<template>
    <view class="u-icon" @tap="clickHandler" :class="['u-icon--' + labelPos]">
        <image class="u-icon__img" v-if="isImg" :src="name" :mode="imgMode" :style="[imgStyle, $u.addStyle(customStyle)]"></image>
        <text v-else class="u-icon__icon" :class="uClasses" :style="[iconStyle, $u.addStyle(customStyle)]" :hover-class="hoverClass">{{icon}}</text>
...
@font-face {
    ...
    // src: url('http://10.2.171.110:8021/icon/font_2225171_8kdcwk4po24.ttf') format('truetype');
}
