...
export default {
	...
	Rqc_RFT_view(data = {}) {
		...
		TransferDataToPivot88(data = {}) {
			debugger;
		    let remark = "//传输数据到pivot88"
		    return myRequest({
		        notTraRetData: true,
		        remark,
		        ClassName: "SJ_RQCAPI.Rqc_taskBase",
		        Method: "TransferDataToPivot88",
		        Data: data,
		    })
		},
