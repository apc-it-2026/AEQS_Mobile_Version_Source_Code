    ...
    <div class='mySelect'>
        ...
        <u-popup :show="checkboxShow" @close="checkboxShow=false" :round="10" closeOnClickOverlay>
            <div class="checkbox">
                ...
                <div class="btnList">
                    <u-button class="btn" type="primary" color="#909399" :text="$t('common.清空选择')" @click="checkedList=[]"></u-button>
                    <u-button type="primary" color="#0ab99c" :text="$t('common.确定')" @click="checkboxConfirm"></u-button>
                </div>
            </div>
        </u-popup>
        <!--搜索选择框-->
