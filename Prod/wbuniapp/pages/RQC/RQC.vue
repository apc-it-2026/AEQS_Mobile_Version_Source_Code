        ...
        <u-collapse :value="$t('common.搜索筛选')" accordion>
            <u-collapse-item :title="$t('common.搜索筛选')" :name="$t('common.搜索筛选')">
                <div class="search myList">
					...
					<!-- Added for PO change Project -->
					<div class="item">
					    <div class="label">Sales Order</div>
					    <div class="value">
					        <u-input v-model="searchForm.so" clearable> </u-input>
					    </div>
					</div>
					<!-- Ended here -->
                    <div class="item2">
            ...
            <list ref="list" :handlerItem="handlerItem" :option="option" :otherData="otherData">
                <template v-slot="{item}">
                    <div class="myList box" @click="toPage('edit',item)">
                        ...
                        <div class="item">
                            <div class="label">Group Po Number:</div>
						...
						<div class="item">
						    <div class="label">Sales Order:</div>
						     <div class="value">{{item.se_id}}</div>
						</div>
                    </div>
                </template>
            </list>
