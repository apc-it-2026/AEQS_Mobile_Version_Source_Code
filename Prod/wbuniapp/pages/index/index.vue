	...
	<view class="index">
		...
		<u-grid border @click="toPage" col="3">
			<template v-for="(baseListItem,baseListIndex) in show?curItem.children:navs">
				<u-grid-item bgColor="#FFF" v-if="env=='dev'|| env=='test'|| !baseListItem.hidden" class="gridItem"
					:key="baseListIndex">
					<u--image class="img" width="30" height="30" mode="aspectFit"
						:src="require(`../../static/indexIcons/${baseListItem.icon}.png`)"></u--image>
				...
				navs: [{
					...
					},
					{
						...
						children: [
							...
							{
								icon: 'RQC',
								title: this.$t('RQC_RFT'),
								path: '../RQC_RFT/RQC_RFT',
							},
