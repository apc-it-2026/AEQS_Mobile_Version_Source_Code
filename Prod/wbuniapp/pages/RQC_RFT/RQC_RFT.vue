<template>
    <div class='RQC'>
        <u-navbar border title="RQC_RFT" :leftText="$t('common.返回')" placeholder autoBack>
                ...
                <template v-slot="{item}">
                    <div class="myList box" @click="toPage('edit',item)">
                        ...
                        <div class="item">
                            ...
                            <div class="value">{{item.inspected_qty}}</div>
                        </div>
                        <div class="item">
                            <div class="label">{{$t('common.合格数量')}}:</div>
                            <div class="value">{{item.pass_qty}}</div>
                        </div>
						<div class="item">
						    <div class="label">{{$t('common.数量不合格')}}:</div>
						    <div class="value">{{item.defect_qty}}</div>
						</div>
                        <div class="item">
                            <div class="label">{{$t('common.合格率')}}:</div>
                            <div class="value">{{item.RFT}}</div>
                        </div>
...
export default {
    ...
    data() {
        return {
            ...
            departmentList: [],
            option: {
                getDataName: 'Rqc_RFT_view',//获取列表数据的方法名
