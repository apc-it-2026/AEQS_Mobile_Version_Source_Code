        ...
        <view v-if="insert || show" class="uni-calendar__content" :class="{'uni-calendar--fixed':!insert,'uni-calendar--ani-show':aniMaskShow, 'uni-calendar__content-mobile': aniMaskShow}">
            <view class="uni-calendar__header" :class="{'uni-calendar__header-mobile' :!insert}">
                ...
                <picker mode="date" :value="date" fields="month" @change="bindDateChange">
                    <text class="uni-calendar__header-text">{{ (nowDate.year||'') + $t('common.年') + ( nowDate.month||'') +$t('common.月')}}</text>
                </picker>
            ...
            <view v-if="!insert" class="uni-date-changed uni-date-btn--ok">
                ...
                <view class="uni-datetime-picker--btn" @click="confirm">{{$t('common.确定')}}</view>
            </view>
        </view>
    </view>
</template>
