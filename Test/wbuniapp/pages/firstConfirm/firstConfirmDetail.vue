                ...
                <uni-card margin="0">
                    <div class="myList">
                        ...
                        <div class="item2">
                            ...
                            <div class="value">
                                <mySelect @confirm="confirmPo" :disabled="query.type!='add'" v-model="addForm.POForm" labelName="mer_po" apiName="firstConfirm_Outmer_po_getlist" scanAbled type="scan"></mySelect>
                            </div>
                        </div>
                        <div class="item">
...
export default {
    ...
    methods: {
        ...
        addSave() {//保存新增
            //表单验证
            if (!this.addForm.POForm.mer_po) return uni.$u.toast(this.$t('common.请填入PO'))
            this.loading = true
            let data = {
