                    ...
                    <div class="myList box" @click="showBurr('0',item)">
                        ...
                        <div class="item">
							...
							<div class="btnList" style = "margin-right: 35rpx;">
							 <u-button v-if="item.changeShow"  size="mini" type="warning" :text="$t('common.换针')" @click.stop.native="sendMsg(item)"></u-button>
							 </div>
                        </div>
                        <div class="item">
            ...
            <div class="add">
                <u--form labelWidth="auto" :model="addForm" :rules="rules" ref="addForm">
                    <u-form-item :label="$t('common.厂区')" prop="org.value">
                        <u--input v-model="addForm.org.label" suffixIcon="arrow-down" readonly @click.native="orgShow=true,production_lineShow=needle_categoryShow=false"></u--input>
                    </u-form-item>
                    ...
                    <u-form-item :label="$t('common.车针')" prop="needle_category.value">
                        <u--input v-model="addForm.needle_category.label" suffixIcon="arrow-down" readonly @click.native="needle_categoryShow=true,production_lineShow=orgShow=false"></u--input>
                    </u-form-item>
                    <u-form-item>
