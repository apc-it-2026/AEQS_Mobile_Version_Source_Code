	...
	<view v-if="isShow" class="picker">
		...
		<view v-if="showTimePicker" class="picker">
			<view class="picker-modal picker-time">
				<view class="picker-modal-header">
					<text class="picker-modal-header-title"></text>
				</view>
				...
				<view class="picker-modal-footer">
					...
					<view class="picker-modal-footer-btn">
						<view class="picker-btn" :hover-stay-time="100" hover-class="picker-btn-active" @click="onCancelTime">{{$t('common.取消')}}</view>
						<view class="picker-btn" :style="{color}" :hover-stay-time="100" hover-class="picker-btn-active" @click="onConfirmTime">{{$t('common.确认')}}</view>
					</view>
				</view>
			</view>
		</view>
